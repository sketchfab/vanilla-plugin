...
$(function() {
    var template = [
        ...
        '       <h3 class="sketchfab-icon">Sketchfab Embed</h3>',
        '       <div class="inner">',
        '           <label for="sketchfab-model">Paste your model link in the following field:</label><br />',
        '           <input type="text" placeholder="https://sketchfab.com/3d-models/cube-test-442c548d94744641ba279ae94b5f45ec" id="sketchfab-model" name="sketchfab-model"/>',
        '       </div>',
        '       <footer>',
     ...
     * When the user writes a discussion or a comment, they can click the Sketchfab button in the
     * editor. If they do, this JS code creates the plugin pane and appends it on the page. In the
     * pane, the user pastes the Sketchfab model URL. The plugin extracts the ID from the URL, and
     * places an <a> tag in the content where the charet was. This tag is then replaced on-the-go by
     * the embed iframe code. This is unfortunately necessary because Vanilla doesn't let iframes be
     * saved and displayed on a page. Other embedding plugins use the same technique.
     */
    ...
    var sketchfab = new SketchfabPlugin({
        ...
        embed: '<iframe width="640" height="480" src="https://sketchfab.com/models/{{}}/embed" frameborder="0" allow="autoplay; fullscreen; vr" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>',
...
var SketchfabPlugin = function SketchfabPlugin(opt) {
    ...
    /*
     * Put the button at the end of the editor toolbar. Unfortunately, there is no hook to render
     * the button after the toolbar has been generated, only before. So we move the button around
     * in JS.
     */
...
// On change value of the text input in the popup, validate the URL.
